...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["luca@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve swimming technique and endurance",
        "schedule": "Mondays and Wednesdays, 3:00 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["natalie@mergington.edu", "sam@mergington.edu"]
    },
    "Art Club": {
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions through experiments and research",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["grace@mergington.edu", "logan@mergington.edu"]
    }
}
